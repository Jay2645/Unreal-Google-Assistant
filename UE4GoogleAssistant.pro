...
unrealRootPath=/home/jay/UnrealEngine
UE4GoogleAssistantRootPath=/home/jay/Documents/Projects/Unreal/UE4GoogleAssistant

gameProjectFile=/home/jay/Documents/Projects/Unreal/UE4GoogleAssistant/UE4GoogleAssistant.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(UE4GoogleAssistantSource.pri)
include(UE4GoogleAssistantHeader.pri)
include(UE4GoogleAssistantConfig.pri)
include(UE4GoogleAssistantIncludes.pri)
include(UE4GoogleAssistantDefines.pri)
...
UE4GoogleAssistant-Linux-Debug.commands = $$build UE4GoogleAssistant Linux Debug  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistant-Linux-DebugGame.commands = $$build UE4GoogleAssistant Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistant-Linux-Shipping.commands = $$build UE4GoogleAssistant Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistant-Linux-Test.commands = $$build UE4GoogleAssistant Linux Test  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistant.commands = $$build UE4GoogleAssistant Linux Development  -project="\"$$gameProjectFile\"" $$args

UE4GoogleAssistantEditor-Linux-Debug.commands = $$build UE4GoogleAssistantEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistantEditor-Linux-DebugGame.commands = $$build UE4GoogleAssistantEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistantEditor-Linux-Shipping.commands = $$build UE4GoogleAssistantEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistantEditor-Linux-Test.commands = $$build UE4GoogleAssistantEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
UE4GoogleAssistantEditor.commands = $$build UE4GoogleAssistantEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4GoogleAssistant-Linux-Debug \
	UE4GoogleAssistant-Linux-DebugGame \
	UE4GoogleAssistant-Linux-Shipping \
	UE4GoogleAssistant-Linux-Test \
	UE4GoogleAssistant \
	UE4GoogleAssistantEditor-Linux-Debug \
	UE4GoogleAssistantEditor-Linux-DebugGame \
	UE4GoogleAssistantEditor-Linux-Shipping \
	UE4GoogleAssistantEditor-Linux-Test \
	UE4GoogleAssistantEditor \
