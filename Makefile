...
UE4GoogleAssistant-Linux-Debug:
	 $(PROJECTBUILD) UE4GoogleAssistant Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistant-Linux-DebugGame:
	 $(PROJECTBUILD) UE4GoogleAssistant Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistant-Linux-Shipping:
	 $(PROJECTBUILD) UE4GoogleAssistant Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistant-Linux-Test:
	 $(PROJECTBUILD) UE4GoogleAssistant Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistant:
	 $(PROJECTBUILD) UE4GoogleAssistant Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistantEditor-Linux-Debug:
	 $(PROJECTBUILD) UE4GoogleAssistantEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistantEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UE4GoogleAssistantEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistantEditor-Linux-Shipping:
	 $(PROJECTBUILD) UE4GoogleAssistantEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistantEditor-Linux-Test:
	 $(PROJECTBUILD) UE4GoogleAssistantEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4GoogleAssistantEditor:
	 $(PROJECTBUILD) UE4GoogleAssistantEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
